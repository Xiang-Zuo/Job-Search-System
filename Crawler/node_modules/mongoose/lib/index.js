 ...
 * @param {{summary: *, hidden: *, company: *, location: *, position: *, tag: *, url: *}} [schema] the schema to use.
 * @param {{collection: string}} [collection] name (optional, inferred from model name)
